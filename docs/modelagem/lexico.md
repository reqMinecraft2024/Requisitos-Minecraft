...
| Nome   | Léxico  |
| --- | --- |
| **Classificação** | Classificação quanto a **Estado**, **Verbo** ou **Objeto** |
| **Sinônimos** | Sinônimos do léxico no contexto |
| **Noção** | Noções do léxicos |
| **Impacto** | Impacto na aplicação |
...
| **Sinônimos** | Inferno, Submundo |
| **Noção** | [Dimensão](#l33-dimensao) alternativa no Minecraft, que é caracterizada por um ambiente hostil e [recursos](#l31-recursos) únicos. |
| **Impacto** | Acesso a [recursos](#l31-recursos) como [Netherite](#l28-netherite) e [Blaze Rods](#l27-blaze-rods). <br> Crucial para progressão no jogo, como alcançar o [End](#l04-end).|
...
| --- | --- |
| **Classificação** | Objeto |
| **Sinônimos** | Fim, Mundo do Dragão |
| **Noção** | [Dimensão](#l33-dimensao) final do Minecraft, lar do [Ender Dragon](#l35-ender-dragon) e de vários [recursos](#l31-recursos) valiosos. |
| **Impacto** | Local da batalha final contra o [Ender Dragon](#l35-ender-dragon). <br> Contém [recursos](#l31-recursos) únicos como [Ender Pearls](#l36-ender-pearls) e [Elytra](#l37-elytra). <br> Marca a conclusão do jogo. |
...
| --- | --- |
| **Classificação** | Estado |
| **Sinônimos** | Modo Hardcore, Extremo |
| **Noção** | Variante do modo [sobrevivência](#l09-sobrevivencia), mas com morte permanente e dificuldade mais alta. |
| **Impacto** | Aumenta a tensão e o desafio do jogo, cada decisão é crucial. |
...
| --- | --- |
| **Classificação** | Objeto |
| **Sinônimos** | Circuitos, Componentes |
| **Noção** | Material no Minecraft usado para criar mecanismos e circuitos elétricos. |
| **Impacto** | Permite a automação e criação de máquinas complexas. <br> Usado em portas automáticas, elevadores, e outras construções avançadas. |
...
| --- | --- |
| **Classificação** | Objeto |
| **Sinônimos** | Modificações |
| **Noção** | Alterações criadas pela comunidade que mudam ou adicionam novos conteúdos ao Minecraft. |
| **Impacto** | Expansão das funcionalidades e conteúdos do jogo. |

### L17 Mineração
| Nome   | Mineração  |
| --- | --- |
| **Classificação** | Verbo |
| **Sinônimos** | Extrair, Garimpar |
| **Noção** | Ação de cavar e coletar [recursos](#l31-recursos) minerais no Minecraft. |
| **Impacto** | Fonte primária de [recursos](#l31-recursos) como carvão, ferro, ouro e diamantes. <br> Essencial para a criação de [ferramentas](#l18-ferramentas) e construção. |
...
| --- | --- |
| **Classificação** | Objeto |
| **Sinônimos** | Bastões de Blaze |
| **Noção** | [Itens](#l32-itens) [dropados](#l30-drops) por [Blazes](#l29-blazes) no [nether](#l01-nether), usados para fabricar [itens](#l32-itens) importantes como Poções. |
| **Impacto** | Essenciais para progressão no jogo e criação de poções. <br> Incentivam a [exploração](#l21-exploracao) e combate no [nether](#l01-nether). |
...
|Classificação|	Objeto|
|Sinônimos|	- |
|Noção	| Hostis [mobs](#l19-criaturas) encontrados no [nether](#l01-nether), conhecidos por seus ataques de fogo.|
|Impacto	| [Dropam](#l30-drops) [Blaze Rods](#l27-blaze-rods), essenciais para a criação de poções e olhos do Ender. <br> Representam um desafio significativo devido aos seus ataques de longo alcance e resistência ao fogo.|
...
**Minecraft Wiki**. Disponível em: <a target="_blank" href="https://minecraft.fandom.com/pt/wiki/Minecraft_Wiki">https://minecraft.fandom.com/pt/wiki/Minecraft_Wiki</a>